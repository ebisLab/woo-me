...
import { addFirstProduct, updateCart, getFormattedCart } from '../../function';
...
const AddToCartButton =(props)=>{
    ...
    //get cart data query 
    const {loading, error, data, refetch}=useQuery(GET_CART,{ //usequery is a method || //refetch function query will be made again if you call it
